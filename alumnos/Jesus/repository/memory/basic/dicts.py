...
if __name__ == '__main__':
    ...
    print_data.print_data(movie_position_0)
    ...
    print_data.print_data(movie_position_1)

    # TODO: Print the movie with id 3

    movie_position_2 = in_memory_repository.get(2)

    print_data.print_data(movie_position_2)
    ...
    print_data.print_data(movie_position_1_updated)
