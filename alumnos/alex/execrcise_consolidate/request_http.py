...
url_post = 'http://localhost:7000/student/1/Ricardo'
url_get = 'http://localhost:7000/students'
url_get_by_id = 'http://localhost:7000/student/1'
url_delete = 'http://localhost:7000/student/1'
url_put = 'http://localhost:7000/student/2/Jesus'
